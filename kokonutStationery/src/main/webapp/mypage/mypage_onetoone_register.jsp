	...
	<div id="onetoone_register_mid">
		<table width="110%" cellpadding="5" cellspacing="10" border="0">
			...
			<tr>
				...
				<td>
					<input class="orderNumber_Input" type="text" name="orderCode" id="orderCode">
			...
			<tr>
				...
				<td>
					<input type="text" name="subject" class="subject_input" id="subject">
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea name="contents" class="content_textarea" id="contents" ></textarea>
				</td>
			</tr>
		</table>
...
$('.confirm_btn').click(function(){
	if($('.qNa_select').val()=='') {
		...
		$.ajax({
			type: 'POST',
			url: '/kokonutStationery/onetoone/onetoone_register.do',
			data: {'userId'	   : '${memId}',
				   'userName'  : '${memName}',
				   'userEmail' : $('#email').val(),
...
$('#order_Number_Btn').click(function(event,str){
	...
	//$('.order_Number_search').toggle();
	$('.order_Number_search').css('display','block');
});
