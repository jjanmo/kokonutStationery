...
<div class="indiv"><!-- Start indiv -->
	...
	<form id="agreement" method="post" action="">
		...
		<div style="margin: 30px 0 0 0;">
			<h5 class="join_tit" style="font-size: 16px; font-weight: 700; text-align: left; margin: 0 0 13px 0;">이용약관</h5>
		</div>		
		
		<div>
			<div class="join_agreement" style="text-align:center;">
				<textarea style="width:100%; height:250px;" class=scroll readonly>제1조(목적) 
		이 약관은 (주)우아한형제들이 운영하는 배민문방구 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. 
		
		제2조(정의) 
		① "몰"이란 (주)우아한형제들이 재화 또는 용역을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다. 
		② "이용자"란 "몰"에 접속하여 이 약관에 따라 "몰"이 제공하는 서비스를 받는 회원 및 비회원을 말합니다. 
		③ '회원’이라 함은 "몰"에 개인정보를 제공하여 회원등록을 한 자로서, "몰"의 정보를 지속적으로 제공받으며, "몰"이 제공하는 서비스를 계속적으로 이용할 수 있는 자를 말합니다. 
		④ '비회원’이라 함은 회원에 가입하지 않고 "몰"이 제공하는 서비스를 이용하는 자를 말합니다. 
		
		제3조(약관등의 명시와 설명 및 개정) 
		① "몰"은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보보호책임자등을 이용자가 쉽게 알 수 있도록 "몰"의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다. 
		...
		부칙 
		1. 이 약관은 2016년 11월 03일부터 적용됩니다.</textarea>
			</div>
	...
	<div align="center" style="padding:40px 0 80px 0">
		<div style="width: 150px; display: inline-block; padding-left: 3px;">
			...
			<div onclick="javascript:history.back()" class="sub-button-s" 
			style="text-align:center; height:60px; width:150px; line-height:55px; font-size: 14px; font-weight:700;">뒤로</div>
		</div>
		<div style="width: 150px; display: inline-block; padding-left: 3px;">
			
			<div type="button" id="nextBtn" class="main-button-s" 
			style="text-align:center; height:60px; width:150px; line-height:55px; font-size: 14px; font-weight:700;">다음</div>
...
$(document).ready(function(){
	...
	$('#nextBtn').click(function(){
		...
		else if(privateVal!='yes')
			alert("[개인정보보호를 위한 이용자 동의사항]에 동의를 하셔야 회원가입이 가능합니다.");
		else if(agreeVal=='yes'&& privateVal=='yes'){
			//$('#agreement').submit();
