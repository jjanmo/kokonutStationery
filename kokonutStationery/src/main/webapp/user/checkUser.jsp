...
<div id="cp_body">
	<form id="confirmForm" name="confirmForm" method="post" action="../user/modifyForm.do">
		...
		<div id="cp_form_border" style="width:738px; height:235px; background:#fff; border:6px solid #efefef; margin:15px 0 30px 0;">
			<div id="cp_form" style="align:center; padding:0;">
				<h4 style="font-size:14px; font-family:Noto Sans KR; text-align:center; font-weight:400; color:#666; line-height: 23px;padding: 20px 0 20px 0;">회원님의 정보를 안전하게 보호하기 위해<br/>비밀번호를 다시 한 번 확인합니다.</h4>
				
				<table cellpadding="4" cellspacing="0" border="0" align="center">
					<tr align="left">
						<td width="70" style="font-size:13px; font-family:Noto Sans KR; font-weight:400; color:#666;">아이디</td>
						<td style="height:40px; color:#333; font-weight:700;" >
					...
					<tr align="left">
						<td width="70">
						<label style="font-size:13px; font-family:Noto Sans KR; font-weight:400; color:#666;">비밀번호</label></td>
						<td>
							<input type="password" name="userPwd" id="userPwd" class="line" 
							style="position:relative; border:1px solid #DDD; width:276px; height:50px; padding-left: 10px; font-size:15px; color: #333; background-color:#fff;  border-radius:0;">
						</td>
					</tr>
				</table>
		...
		<!-- 확인, 취소 버튼 -->	
		<div  style=" align:center; padding:0 0 80px 200px">
			<div style="text-align:center;  width: 150px; display: inline-block; border:1px solid #A4A4A4;">
				<a href="javascript:void(0);" onclick="history.go(-1);" style="text-decoration:none;">
				 <span id="cancelBtn" style="font-family:Noto Sans KR; color:#a4a4a4; cursor:pointer; height:60px; width:150px; line-height:60px; 
