		...
		<div class="indiv" style="margin: 135px 10px 0 20px;">
			...
			<form name="CartForm" method="post" action="/kokonutStationery/cart/goods_cart_modify.do">
				...
				<table width="100%" cellpadding="0" cellspacing="0" border="0"
					...
					<tr>
						<th class="cart_select"
							style="cursor: pointer; border-top: 1px solid #999;">선택</th>
					...
					<c:if test="${list.size()!=0}">
						<c:forEach var="cartDTO" items="${list }" varStatus="status">
							...
							<tr>
								<td id="cart_checkbox"
									style="vertical-align: top; padding: 30px 17px;"><input
									type="checkbox" name="cartCheckbox" class="checkbox${cnt}"
									checked></td>

								<td style="vertical-align: top; padding: 30px 17px;"><a
									href="" style="margin-bottom: 0;"> <img
										src="../image/thumb/${cartDTO.thumbImg }" width="70px"
										onerror=""></a></td>

								<td class="orderOption"
									style="text-align: left; vertical-align: top; padding: 30px 0;">
									<div class="thumbImg">${cartDTO.productName}</div> <!-- 선택옵션 내용 시작 -->
									<c:if test="${cartDTO.productOption==1}">
										<font id="${cartDTO.cartCode }"
											style="font-weight: normal; font-size: 12px; color: #666; line-height: 23px; margin: 0 -104px 0;">
											&emsp;[&nbsp;${cartDTO.optionContent}&nbsp;] </font>
										<a href="goods_cart_edit.do?cartCode=${cartDTO.cartCode}" data-width="600"
											data-height="400" class="popup"
											style="margin-bottom: 0px; margin-top: 13px;">
											<li class="optionButton" style="margin: 26px 0 0;">선택옵션수정</li>
										</a>
									</c:if> <!--<c:if test="${cartDTO.productOption==0 }">
										<a href="goods_cart_edit.do?productCode=${cartDTO.productCode}" data-width="600"
											data-height="400" class="popup"
											style="margin-bottom: 0px; margin-top: 13px;">
								...
								<td class="price"><f:formatNumber pattern="###,###,###"
										value="${cartDTO.discountPrice }" />원</td>
										...
										<tr>
											<td style="padding: 0; height: 0px; border: 0">
												<div style="float: left;">
													<input type="text" name="productQty" id="${status.index}"
														step="1" min="1" max="0" size="2"
								...
								<td
									style="vertical-align: top; color: #333; text-align: right; padding: 30px 0; font-weight: 700; padding-right: 20px;">
									<f:formatNumber pattern="###,###,###"
										value="${cartDTO.discountPrice * cartDTO.productQty }" />원
								</td>
							</tr>
						</c:forEach>
					</c:if>
						...
						<td colspan="10" style="padding: 30px 0;">
							<table width="100%" cellpadding="0" cellspacing="0"
								...
								<tr class="totalPrice" style="padding-right: 0px;">
									<td style="border: none;"><font
										style="color: #333; font-weight: 500;"> 상품합계금액 (배송비 별도)
									</font> &nbsp;&nbsp;&nbsp;&nbsp; <font
										style="font-family: 'Montserrat', sans-serif; font-size: 24px; color: #2ac1bc; font-weight: 700;">
											<c:if test="${list.size()==0}">
											0
										...
										style="font-size: 15px; color: #2ac1bc; font-weight: 700;">
											원 </font></td>
								</tr>
							</table>
						</td>
			...
			<c:if test="${list.size()==0}">
				<div class="cart_button">
					<div class="none_previous subButton-xs"
						style="width: 140px; margin: 31px 0px -60px 260px;">이전으로</div>
					<div class="none_allDelete subButton-xs"
						style="width: 140px; margin: 0px 469px 0 412px;">비우기</div>
					<div class="shopContinue main-button-s"
						style="width: 140px; margin: -59px 564px 0px;">쇼핑계속하기</div>
				</div>
			</c:if>
						...
						<td>
							<div>
								...
								<div class="selectDelete"
									...
									<a href="" onfocus="blur()"><li
										class="subButton subButton-xs">선택 삭제</li></a>
								</div>
								<div class="allDelete"
									style="width: 140px; display: inline-block; padding-left: 5px;">
									<a href="/kokonutStationery/cart/allDeleteCart.do"><li
										class="subButton subButton-xs">비우기</li></a>
								</div>
								<div class=""
									style="width: 140px; display: inline-block; padding-left: 5px;">
								...
								<div class="selectOrder"
									style="width: 140px; display: inline-block; padding-left: 5px;">
									<a href="/kokonutStationery/order/order.do"><li class="main-button-s">선택 주문하기</li></a>
								</div>
							</div>
						</td>
					</tr>
