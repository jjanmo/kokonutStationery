...
<div id="open_confirmModal" class="modal">
  ...
  <div class="modal-content">
            <p style="text-align: center;"><span style="font-size: 14pt;"><b><span style="font-size: 24pt;">문의답변등록</span></b></span></p>
...
<div id="main_wrap" align="left" style="width:850px; margin:30px auto;">
	...
	<div>
		<h1 style="font-weight:normal;">문의 답변 등록</h1>
	</div>
	<div id="qna_info">
		<table id="qna_info_table" border="1" style="width:100%; border: 1px solid #d9dadc; border-spacing: 0; line-height: 1.5; margin-top: 50px;">
			<tr>
				<th>제  목</th>
				<td>
					<input type="text" id="qnaboardSubject" value="[코코넛문방구]답변드립니다." />
			...
			<tr>
				<th>내  용</th>
				<td>
					<textarea id="qnaboardContent" cols="60" rows="30" ></textarea>
...
$().ready(function(){
	...
	$('#confirmOK_Modal').click(function(){
		$.ajax({
			type : 'post',
			url : '/kokonutStationery/admin/qnaboardReply.do',
