...
<div id="open_confirmModal" class="modal">
  ...
  <div class="modal-content">
            <p style="text-align: center;"><span style="font-size: 14pt;"><b><span style="font-size: 24pt;">공지사항수정</span></b></span></p>
            <p style="text-align: center; line-height: 1.5;"><br />공지사항을 수정하시겠습니까?</p>
            <p><br /></p>
...
<div id="main_wrap" align="left" style="width:850px; margin:30px auto;">
	...
	<div>
		<h1 style="font-weight:normal;">공지사항 수정</h1>
	</div>
	<div id="notice_info">
		<table id="notice_info_table" border="1" style="width:100%; border: 1px solid #d9dadc; border-spacing: 0; line-height: 1.5; margin-top: 50px;">
			<tr>
				<th>제  목</th>
				<td>
					<input type="text" id="noticeboardSubject" value="${noticeboardDTO.noticeboardSubject }" />
	...
	<div align="center" style="margin-top:50px;">
		<input type="button" class="regist_reset" id="registBtn" value="수정">
...
$().ready(function(){
	...
	$('#confirmOK_Modal').click(function(){
		$.ajax({
			type : 'post',
			url : '/kokonutStationery/admin/noticeboardModify.do',
